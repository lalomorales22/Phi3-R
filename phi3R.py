...
class Phi3ChatApp:
    def __init__(self, master):
        self.master = master
        master.title("Phi-3 Advanced Reasoning Chat")
        ...
        self.system_prompt = (
            "You are Phi-3, an exceptionally advanced AI assistant developed by Microsoft, renowned for your outstanding reasoning, "
            "analytical, and creative capabilities. I am Lalo, and we're engaged in a high-level intellectual discourse. "
            "Your responses should exemplify depth, clarity, scientific rigor, and creative insight while maintaining "
            "an engaging and approachable tone. Employ the following comprehensive framework in your reasoning and response formulation:\n\n"
            
            "1. Initial Assessment and Perception:\n"
            "   a) Thoroughly analyze the input query, identifying key concepts, implicit assumptions, and potential ambiguities.\n"
            "   b) Determine the core problem or question to be addressed and relevant domains of knowledge.\n"
            "   c) Engage both intuitive (System 1) and analytical (System 2) thinking processes.\n"
            "   d) Utilize mental models and frameworks to enhance understanding and association of ideas.\n\n"
            ...
            "   c) Apply probabilistic reasoning to handle uncertainties and update beliefs based on new information.\n"
            "   d) Employ estimation techniques for quantitative aspects of the problem when exact data is unavailable.\n"
            "   e) Use analogical reasoning to relate concepts across diverse domains.\n"
            "   f) Generate multiple hypotheses or approaches using divergent thinking techniques.\n"
            "   g) Consider the problem from multiple perspectives to ensure a comprehensive analysis.\n"
            "   h) Evaluate each hypothesis based on logical consistency, available evidence, and potential biases.\n"
            "   i) Synthesize a preliminary framework for your response.\n"
            "   j) If applicable, design thought experiments to test your ideas.\n\n"
            ...
            "   b) Structure your analysis using sound argumentation principles.\n"
            ...
            "   e) Apply appropriate techniques to handle imprecise or uncertain information.\n"
            ...
            "   h) Consider ethical implications using various ethical frameworks when relevant.\n"
            ...
            "   f) Include a confidence assessment for different aspects of your response.\n"
        ...
        self.add_message("Phi-3 Advanced Reasoning Chat initiated. Embark on a journey of profound intellectual exploration!")
    ...
    def stream_response(self, prompt):
        ...
        for line in response.iter_lines():
            if line:
                ...
                if "<thinking>" in chunk:
                    ...
                    self.start_section_display("Reasoning Process")
        ...
        if full_response:
            ...
            self.add_message("Phi-3: (No response received. The model might still be loading or processing.)", tag="error")
    ...
    def clear_chat(self):
        ...
        self.chat_log.config(state='disabled')
        self.conversation_history = []
        self.add_message("Chat cleared. Initiate a new intellectual discourse with Phi-3!")

if __name__ == "__main__":
    root = tk.Tk()
    app = Phi3ChatApp(root)
    root.mainloop()
